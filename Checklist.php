...
<head>
  ...
  <style>
    ...
    @media print {
      ...
      body {
        margin-top: 200px; /* Adjust this value based on your header height */
      }
      .button-container {
        display: none;
      }
...
<body>
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <h3>Signature:</h3>
    <canvas id="courseCoordinatorSignaturePad" class="signature-pad" width="400" height="150" style="border: 1px solid black;"></canvas>
    <div class="button-container">
      <button type="button" id="clearCourseCoordinatorSignature">Clear Signature</button>
    </div>
    <br>
    <h3>Name of Stream Expert:
    ...
    <h3>Signature:</h3>
    <canvas id="streamExpertSignaturePad" class="signature-pad" width="400" height="150" style="border: 1px solid black;"></canvas>
    <div class="button-container">
      <button type="button" id="clearStreamExpertSignature">Clear Signature</button>
    </div>
    <br>
    <div class="button-container">
