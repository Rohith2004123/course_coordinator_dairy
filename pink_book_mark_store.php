...
$sub_code = filter_var($_POST['subject'], FILTER_SANITIZE_STRING);
$sub_name_query = "SELECT sub_name FROM subjects WHERE sub_code='$sub_code'";
$sub_name_result = $conn->query($sub_name_query);

if ($sub_name_result->num_rows > 0) {
    $sub_name_row = $sub_name_result->fetch_assoc();
    $sub_name = $sub_name_row['sub_name'];
} else {
