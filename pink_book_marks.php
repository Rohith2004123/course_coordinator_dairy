...
<script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var assessmentCheckboxes = document.querySelectorAll('.assessment-checkbox');
            assessmentCheckboxes.forEach(checkbox => {
                checkbox.addEventListener('change', function () {
                    var marksInput = this.parentNode.querySelector('.marks-input');
                    var coSelect = this.parentNode.querySelector('.co-select');
                    if (this.checked) {
                        marksInput.style.display = 'inline-block';
                        coSelect.style.display = 'inline-block';
                    } else {
